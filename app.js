...
setInterval(() => {
  https.get("https://transport-3d8k.onrender.com", (res) => {
...
app.delete('/api/notifications/:id', async (req, res) => {
  try {
    ...
    if (notif.imageUrl) {
      const filePath = path.join(__dirname, notif.imageUrl);
    ...
    io.to('students').emit('notificationDeleted', notif._id.toString());
